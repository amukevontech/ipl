...
class CricketAPIServices {
    ...
    ballByBall(matchKey,over){
        let apiPath = '/rest/v2/match/'+matchKey+'/balls/'+over+'/';
        let params = {};
    ...
    seasonTeam(seasonKey, seasonTeamKey){
        let apiPath = '/rest/v2/season/'+seasonKey+'/team/'+seasonTeamKey+'/';
        let params = {};
        return new Promise((resolve, reject) => {
            resolve(this.getData(apiPath, params));
        }).catch(function(err) {
